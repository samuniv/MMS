...
namespace MeetingManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251029031912_AddNotificationPreferencesAndHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetingManagementSystem.Core.Entities.NotificationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RelatedActionItemId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RelatedActionItemId");
            ...
            modelBuilder.Entity("MeetingManagementSystem.Core.Entities.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("ActionItemAssignments")
                        .HasColumnType("boolean");

                    b.Property<bool>("ActionItemReminders")
                        .HasColumnType("boolean");

                    b.Property<bool>("ActionItemUpdates")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("MeetingCancellations")
                        .HasColumnType("boolean");

                    b.Property<bool>("MeetingInvitations")
                        .HasColumnType("boolean");

                    b.Property<bool>("MeetingReminders")
                        .HasColumnType("boolean");

                    b.Property<bool>("MeetingUpdates")
                        .HasColumnType("boolean");

                    b.Property<bool>("Reminder1Hour")
                        .HasColumnType("boolean");

                    b.Property<bool>("Reminder24Hours")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MeetingManagementSystem.Core.Entities.NotificationHistory", b =>
                {
                    b.HasOne("MeetingManagementSystem.Core.Entities.ActionItem", "RelatedActionItem")
                        .WithMany()
                        .HasForeignKey("RelatedActionItemId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MeetingManagementSystem.Core.Entities.Meeting", "RelatedMeeting")
                        .WithMany()
                    ...
                    b.Navigation("RelatedActionItem");
            ...
            modelBuilder.Entity("MeetingManagementSystem.Core.Entities.NotificationPreference", b =>
                {
                    b.HasOne("MeetingManagementSystem.Core.Entities.User", "User")
                        ...
                        .HasForeignKey("MeetingManagementSystem.Core.Entities.NotificationPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
